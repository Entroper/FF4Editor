...
public partial class FF4Rom
{
    ...
    public WorldTileset LoadWorldMapTileset(MapType mapType)
    {
        ...
        return new WorldTileset(subTiles, formations, palette, paletteOffsets, tileProperties);
    }
    ...
    public void SaveWorldMapTileset(MapType mapType, WorldTileset tileset)
    {
